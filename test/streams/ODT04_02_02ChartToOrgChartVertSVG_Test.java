 ...
 * @author wilfongj
 */
public class ODT04_02_02ChartToOrgChartVertSVG_Test {

    public static void main(String[] args) throws Exception {
        System.out.println("ODT04_02_01ChartToOrgChartVertSVG_Test 1");
    ...
    private static void testImportText() throws FileNotFoundException, IOException, UnknownFileTypeException, TransformerException {
        ...
        String filename = "HIT_Implementation_Manager.02.vertcial.flashcards.odt";
